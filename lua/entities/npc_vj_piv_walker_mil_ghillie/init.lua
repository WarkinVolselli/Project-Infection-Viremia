...
self.SoundTbl_Death = {
	...
	if math.random(1,3) == 1 && self.PIV_WeHaveAWeapon == false && self.PIV_Jogger == false && self.PIV_Shambler == false && self.PIV_FuckingCrawlingLittleCunt == false then
		self.PIV_LittleBastard = true
	end
end
---------------------------------------------------------------------------------------------------------------------------------------------
function ENT:Zombie_CustomOnThink_AIEnabled()
	if IsValid(self:GetEnemy()) && self.PIV_Crippled == false && self.PIV_LittleBastard == true then
