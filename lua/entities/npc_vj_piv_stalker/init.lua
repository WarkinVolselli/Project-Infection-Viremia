...
function ENT:Zombie_CustomOnPreInitialize()
	self.Model = {"models/vj_piv/hl2/combine/Combine_Soldier.mdl"} -- The game will pick a random model from the table when the SNPC is spawned | Add as many as you want
...
function ENT:Zombie_CustomOnDeath_Initial(dmginfo, hitgroup)
	...
	VJ.EmitSound(self,{"ambient/energy/spark1.wav","ambient/energy/spark2.wav","ambient/energy/spark3.wav","ambient/energy/spark4.wav","ambient/energy/spark5.wav","ambient/energy/spark6.wav"},100,math.random(100,95))
	...
	timer.Simple(0.8,function() if IsValid(self) then
		self:SetMaterial("models/alyx/emptool_glow")
		VJ.EmitSound(self,{"ambient/energy/zap1.wav","ambient/energy/zap2.wav","ambient/energy/zap3.wav","ambient/energy/zap5.wav","ambient/energy/zap6.wav","ambient/energy/zap7.wav","ambient/energy/zap8.wav","ambient/energy/zap9.wav"},100,math.random(100,95))
